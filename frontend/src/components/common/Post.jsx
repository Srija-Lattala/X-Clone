...
const Post = ({ post }) => {
    ...
    const postOwner = post.user || {}; // Fallback to prevent errors if user is undefined
    const isLiked = false;
    const isMyPost = true;
        ...
        <div className="flex gap-2 items-start p-4 border-b border-gray-700">
            <div className="avatar">
                <Link to={`/profile/${postOwner.username || "#"}`} className="w-8 rounded-full overflow-hidden">
                    <img src={postOwner.profileImg || "/avatar-placeholder.png"} alt="User Profile" />
                </Link>
            </div>
